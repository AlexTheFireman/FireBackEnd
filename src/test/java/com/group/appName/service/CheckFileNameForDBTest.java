...
class CheckFileNameForDBTest {
    ...
    void isFileNameExistInList() {
        File file = new File("C:/Users/Alex/IdeaProjects/appName/src/test/resources/FileFolder");
        List<File> files = Arrays.asList(file.listFiles());
        List <String> fileNames = new ArrayList<>();
        files.forEach(f -> fileNames.add(f.getName()));
        fileNames.forEach(fileName -> System.out.println(fileName));
        File testFile = new File("C:/Users/Alex/IdeaProjects/appName/src/test/resources/FileFolder/TestTable.xlsx");
